<div id="header-wrapper">
    ...
    <div class="teaser-wrapper">
        <div class="teaser teaser-phosphor">
            <video class="teaser-video" autoplay loop width="100%" height="auto">
                <source type="video/mp4" src="files/video/bild_mit_grafik_P-Rueckgewinnung.mp4" title="bild_mit_grafik_P-Rueckgewinnung.mp4">
            </video>
